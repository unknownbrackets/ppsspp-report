...
var FORMATTED_MESSAGE_LENGTH = 1024;
...
{
	var args = {'version': version.substr(0, VERSION_TITLE_LENGTH)};
...
{
	var args = {'id_game': id_game, 'title': title.substr(0, GAME_TITLE_LENGTH)};
...
{
	var args = {'message': message.substr(0, MESSAGE_KIND_LENGTH)};
...
{
	args.formatted_message = args.formatted_message.substr(0, FORMATTED_MESSAGE_LENGTH);
	conn.query('\
		SELECT id_msg \
