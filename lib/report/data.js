...
function getVersionId(conn, version, cb)
{
	...
	conn.queryGrab('\
		CALL create_version(:version, :value)', args, cb);
}
...
function getGameId(conn, id_game_unsafe, title, cb)
{
	...
	conn.queryGrab('\
		CALL create_game(:id_game, :title)', args, cb);
}
...
function getMessageKindId(conn, message, cb)
{
	...
	conn.queryGrab('\
		CALL create_report_message_kind(:message)', args, cb);
}
...
function getGpuId(conn, gpu, gpu_full, cb)
{
	...
	conn.queryGrab('\
		CALL create_gpu(:short_desc, :long_desc)', args, cb);
}
...
function getCpuId(conn, cpu, cb)
{
	...
	conn.queryGrab('\
		CALL create_cpu(:summary)', args, cb);
}
...
function getPlatformId(conn, platform, cb)
{
	...
	conn.queryGrab('\
		CALL create_platform(:title)', args, cb);
}
