...
function list_all(req, res)
{
	...
	async.auto({
		...
		perfect_count: list.getCount.bind(list, { compat: 'perfect' }),
		playable_count: list.getCount.bind(list, { compat: 'playable' }),
		ingame_count: list.getCount.bind(list, { compat: 'ingame' }),
		menu_count: list.getCount.bind(list, { compat: 'menu' }),
		none_count: list.getCount.bind(list, { compat: 'none' }),
		unknown_count: list.getCount.bind(list, { compat: 'unknown' }),
	}, function (err, data)
	{
		if (err)
		{
